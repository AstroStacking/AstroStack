...
int main(int argc, char** argv)
{
    ...
    QCoreApplication::setApplicationName("GraphMatching");
    QCoreApplication::setApplicationVersion("0.2.0");

    QCommandLineParser parser;
    parser.setApplicationDescription("Graph Matching");
    ...
    astro::processing::graphmatching(inputDataset, group, outputDatasetName, parser.value(minStarsOption).toInt(),
